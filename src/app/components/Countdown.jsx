    ...
    return (
        ...
        >
            ...
            >
                ...
                <motion.h1
                    className="text-4xl md:text-6xl py-1 md:py-2 font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-red-100 to-red-500 mb-4"
                    style={{
                        filter: "drop-shadow(0 0 25px rgba(179, 56, 152, 0.9))",
                    }}
                >
                    Every heartbeat counts down to your special day 💖
                </motion.h1>
                <p className="text-lg text-pink-100">This isn't just a moment — it's a memory in the making.</p>
            </motion.div>
                    ...
                    return (
                        ...
                        >
                            <motion.div
                                ...
                                style={{
                                    boxShadow: "0 4px 20px rgba(39, 94, 247, 0.97), 0 0 20px rgba(243, 29, 29, 0.95)",
                                }}
                            >
            ...
            >
                ...
                <p className="text-purple-300 text-base">😊💕A tiny effort, but a huge wish, with one hope to light up your face with a smile.😊💕</p>
            </motion.div>
        </motion.div>
    )
}
